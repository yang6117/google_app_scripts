function addRegistoMaster2() {
  var sheetSrc = SpreadsheetApp.openById("1R5tc-DJvr54p78EKw1BDTXF8yReOcnZI8ERQ6GY_0pM").getActiveSheet();
  var sheetDest = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("DAY OF PREREG $20/$30 (883 - 1000)");//////////////////////////////////////////////////////////////////////////////
  var data = sheetSrc.getDataRange().getValues();
  var ticketnum = 1;

  for (var client=403; client < 457; client++) { // client is individual ticket seller. clients can have 
